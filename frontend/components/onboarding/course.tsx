        ...
        <div className="bg-white relative min-h-screen items-center py-38">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12">
                    <ScrollAnimatel delay={150} direction="up">  <h2 className="text-sm uppercase tracking-wider text-red-500 font-semibold mb-2">
                        The Problem
                    </h2> </ScrollAnimatel>
                    <ScrollAnimatel delay={180} direction="left">       <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                        Learning Shouldn't Be This Hard
                    </h1> </ScrollAnimatel>
                    <ScrollAnimatel delay={200} direction="right">        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Most teams rely on disconnected tools that create confusion instead of clarity.
                    </p> </ScrollAnimatel>
                </div>

                {/* Features Grid */}
                <ScrollAnimatel delay={220} direction="down">
            ...
            <ScrollAnimatel delay={260} direction="up">
                <div className="lg:max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col  lg:flex-row gap-10 mt-20 md:mt-0">
                    ...
                    <ScrollAnimatel delay={280} direction="right">
